...
var client_references_default = {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-CaW8QoiO.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"8f7ba5393f33": async () => {
		const m = await import("./assets/error-boundary-CD1-RdMo.js");
		return {
			get "ErrorBoundary"() {
	...
	"ee6cb3d92c61": async () => {
		const m = await import("./assets/layout-segment-context-CWL7XP8n.js");
