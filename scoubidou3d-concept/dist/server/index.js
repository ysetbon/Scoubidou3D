globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-jQR7dAlc.js","assets/layout-segment-context-BU_bw35a.js"];
...
function getDraftSecret() {
	return "8abe04d1-9e75-4caa-8e4f-6ab8c6268da6";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "6fbf6ba6-b608-41e0-9869-c8bc3bb7492a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "6fbf6ba6-b608-41e0-9869-c8bc3bb7492a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "6fbf6ba6-b608-41e0-9869-c8bc3bb7492a",
		rootBoundaryId
	});
}
/**
