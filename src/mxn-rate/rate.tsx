  ...
  const load = async () => {
    ...
    try {
      ...
      setStatus(list.length ? ""
        ...
        : kind === "semi" ? "No near-misses saved yet — open a band with ⚑H or ⚑V on a level card in the lab, then flag one with 🚩. The ⭐ next to it saves closed rings, which land in the other queue."
